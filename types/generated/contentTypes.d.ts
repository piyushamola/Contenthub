...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::about.about'> &
      Schema.Attribute.Private;
    oisdfljsad: Schema.Attribute.JSON &
...
export interface ApiAuthorTpAuthorTp extends Struct.CollectionTypeSchema {
  collectionName: 'author_tps';
  info: {
    displayName: 'author-tp';
    pluralName: 'author-tps';
    singularName: 'author-tp';
  };
  options: {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    facebook: Schema.Attribute.UID;
    instagram: Schema.Attribute.UID;
    linkedin: Schema.Attribute.UID;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiCollapsibleCollapsible extends Struct.CollectionTypeSchema {
  ...
  info: {
    ...
    pluralName: 'collapsibles';
    singularName: 'collapsible';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiProductWidgetProductWidget
  extends Struct.CollectionTypeSchema {
  collectionName: 'product_widgets';
  info: {
    displayName: 'Product Widget';
    pluralName: 'product-widgets';
    singularName: 'product-widget';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::product-widget.product-widget'
    > &
      Schema.Attribute.Private;
    productCtaText: Schema.Attribute.String;
    productDescription: Schema.Attribute.Text;
    productDisclaimer: Schema.Attribute.String;
    productHeading: Schema.Attribute.Text;
    productImage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    productName: Schema.Attribute.String;
    productSubHeading: Schema.Attribute.Text;
...
export interface ApiSubVerticalSubVertical extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.UID<'displayName'>;
    publishedAt: Schema.Attribute.DateTime;
    SubVertical: Schema.Attribute.Relation<
      'manyToOne',
      'api::vertical.vertical'
    >;
    subVerticalDescription: Schema.Attribute.Text;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiTimePassTimePass extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::time-pass.time-pass'
    > &
      Schema.Attribute.Private;
    metaDescription: Schema.Attribute.String;
    metaTitle: Schema.Attribute.String;
    priority: Schema.Attribute.UID;
    product_widgets: Schema.Attribute.Relation<
      'oneToMany',
      'api::product-widget.product-widget'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiVerticalVertical extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    displayName: Schema.Attribute.String;
    isSubVertical: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::vertical.vertical'
    ...
    name: Schema.Attribute.UID<'displayName'>;
    publishedAt: Schema.Attribute.DateTime;
    sub_verticals: Schema.Attribute.Relation<
      'oneToMany',
      'api::sub-vertical.sub-vertical'
    >;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::time-pass.time-pass': ApiTimePassTimePass;
